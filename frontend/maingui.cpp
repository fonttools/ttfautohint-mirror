...
Main_GUI::create_layout(bool horizontal_layout)
{
  ...
  control_label->setToolTip(
    tr("<p>An optional control instructions file to tweak hinting."
       ...
       "<tt>point</tt> defines delta exceptions"
       ...
       " <tt>point</tt>, <tt>xshift</tt>, and <tt>yshift</tt>"
       " can be abbreviated as <tt>l</tt>, <tt>r</tt>, <tt>n</tt>,"
       " <tt>p</tt>, <tt>x</tt>, and <tt>y</tt>, respectively.<br>"
       ...
       "&nbsp;&nbsp;<tt>Adieresis point 3-6 yshift 0.25 @ 13</tt>"));
