% For non-ASCII characters, this template has only been tested with XeTeX.
...
\ifxetex
  ...
  % XXX no sans serif font yet available
...
% XXX no Noto font available yet
% \newfontfamily{\yezidifont}[Script=Yezidi]{NotoSansYezidi-Regular.ttf}
  ...
  \setTransitionsForDevanagari{\begingroup\devanagarifont}{\endgroup}
  ...
  \setTransitionTo{HanifiRohingya}{\begingroup\hanififont}
  \setTransitionFrom{HanifiRohingya}{\endgroup}
  ...
  \setTransitionTo{Medefaidrin}{\begingroup\medefaidrinfont}
  \setTransitionFrom{Medefaidrin}{\endgroup}
  ...
  \setTransitionTo{NyiakengPuachueHmong}{\begingroup\hmongpfont}
  \setTransitionFrom{NyiakengPuachueHmong}{\endgroup}
...
% \setTransitionTo{Yezidi}{\begingroup\yezidifont}
% \setTransitionFrom{Yezidi}{\endgroup}
